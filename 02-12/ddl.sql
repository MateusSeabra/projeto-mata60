...
CREATE INDEX form_to_component ON Form_To_Component(form_id, component_id) USING BTREE;

CREATE INDEX submission_values ON Submission_Values(component_id, submission_id) USING BTREE;
